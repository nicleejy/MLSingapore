# ml_singapore guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `ml_singapore/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `ml_singapore` folder and use the modules inside your notebooks :
...
```python
from ml_singapore.utils.paths import data_dir
data_dir()
```
